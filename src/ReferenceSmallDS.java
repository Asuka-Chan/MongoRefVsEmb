...
public class ReferenceSmallDS {
    public static void main(String[] args) {
        ...
        MongoCollection<Document> collection = database.getCollection("referenceSmallStudentTest");
        MongoCollection<Document> collectionCourse = database.getCollection("referenceSmallCourseTest");
